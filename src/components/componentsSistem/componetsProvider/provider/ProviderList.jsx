  ...
  import ProdListProv from "../prodListProv/ProdListProv";
      ...
      <div className="page-center">
        <div className="provider">
          ...
          {isLoading ? (
            ...
            <Table bordered hover responsive>
              ...
              <tbody>
                {providers.length === 0 ? (
                  <tr>
                    <td colSpan={5} className="text-center">No hay proveedores</td>
                  </tr>
                ) : (
                  providers.map((p) => (
          ...
          <ProdListProv
            ...
            onHide={() => { setShowProductsModal(false); setSelectedProviderId(null); }}
            providerId={selectedProviderId}
            refetchParent={refetch} // opcional, para refrescar la lista de proveedores si hace falta
          />
        </div>
      </div >
    );
